...
For generated art plates, invoke the `canvas-design` skill. For placement into slides, hand off to `prestige-slate-deck`, which carries the scrim, type, and layout specifications.
